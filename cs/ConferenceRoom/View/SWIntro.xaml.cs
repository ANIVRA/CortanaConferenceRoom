...
namespace ConferenceRoom.View
{
    ...
    /// </summary>
    public sealed partial class SWIntro : Page
    {
        ...
        public SWIntro()
        {
            ...
            bitmapImage.UriSource = new Uri(BaseUri, "/Assets/starwars_poster.jpg");
            SWImage.Source = bitmapImage;
        ...
        private async void NavigationHelperOnLoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var file = await folder.GetFileAsync("SWIntro.mp3");
