...
namespace ConferenceRoom.VoiceCommands
{
    /// <summary>
    ...
    /// ConferenceRoomCommands.xml VCD file in the ConferenceRoom project. The service
    /// entrypoint is defined in the Package Manifest (See section uap:Extension in 
    /// ConferenceRoom:Package.appxmanifest)
    /// </summary>
    public sealed class VoiceCommandService : IBackgroundTask
    {
        ...
        private async Task PPoint()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Error opening file  " + ex.ToString());
            }
        }
        ...
        private async void LaunchAppInForeground()
        {
            ...
            userMessage.SpokenMessage = cortanaResourceMap.GetValue("LaunchingConferenceRoom", cortanaContext).ValueAsString;
